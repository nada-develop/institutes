                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" id="validationCustom01"
                                                name="teacher_code" placeholder="كود المعلم" required />
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="validationCustom01"
                                                name="teacher_name" placeholder="الاسم " required />
                                            <div class="valid-feedback">
                                                Looks good!
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" id="validationCustom01"
                                                name="record_number" placeholder="رقم السجل " required />
                                            <div class="valid-feedback">
                                                Looks good!
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="date" class="form-control" id="validationCustom03"
                                                name="qualification_date" required>
                                            <div class="invalid-feedback">
                                                Required Field
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group mb-2">
                                            ...
                                            <input
                                                ...
                                                name="region_code" id="region_code" readonly required>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group mb-2">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group mb-2">
                                            ...
                                            <input
                                                ...
                                                name="management_code" id="management_code" readonly required>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group mb-2">
